...
static void createModuleCodeObjects(void) {
    ...
    codeobj_afbb1f37b73d51d1b1a027237023eca3 = MAKE_CODE_OBJECT(module_filename_obj, 8, CO_NOFREE, mod_consts[36], mod_consts[36], mod_consts[46], NULL, 0, 0, 0);
...
// Mark the execution in the "__spec__" value.
    ...
    // owning it.
    pushFrameStack(frame_3a640e46aa600c1b51ae8d6670e77e98);
    ...
    branch_end_2:;
    {
        ...
        tmp_res = PyObject_SetItem(locals_anyio$abc$_resources$$$class__1_AsyncResource_8, mod_consts[34], tmp_dictset_value);
        if (tmp_res != 0) {
            assert(ERROR_OCCURRED());
        ...
        tmp_res = PyObject_SetItem(locals_anyio$abc$_resources$$$class__1_AsyncResource_8, mod_consts[37], tmp_dictset_value);
        if (tmp_res != 0) {
            assert(ERROR_OCCURRED());
        ...
        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStack(frame_afbb1f37b73d51d1b1a027237023eca3_2);
        ...
        }
        {
            ...
            tmp_subscript_value_2 = PyObject_GetItem(locals_anyio$abc$_resources$$$class__1_AsyncResource_8, mod_consts[40]);
            ...
            tmp_annotations_2 = _PyDict_NewPresized( 4 );
            {
                ...
                tmp_subscript_value_3 = PyObject_GetItem(locals_anyio$abc$_resources$$$class__1_AsyncResource_8, mod_consts[40]);
        ...
        goto try_except_handler_3;
        outline_result_1:;
        UPDATE_STRING_DICT1(moduledict_anyio$abc$_resources, (Nuitka_StringObject *)mod_consts[36], tmp_assign_source_17);
    }
    goto try_end_3;
    // Exception handler code:
