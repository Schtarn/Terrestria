...
static void createModuleConstants(void) {
    if (constants_created == false) {
        loadConstantsBlob(&mod_consts[0], UNTRANSLATE("uvicorn._subprocess"));
...
#ifndef __NUITKA_NO_ASSERT__
void checkModuleConstants_uvicorn$_subprocess(void) {
...
static PyObject *impl_uvicorn$_subprocess$$$function__1_get_subprocess(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_30877c9257859b33b54dfc683846f418 = MAKE_FUNCTION_FRAME(codeobj_30877c9257859b33b54dfc683846f418, module_uvicorn$_subprocess, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStack(frame_30877c9257859b33b54dfc683846f418);
...
static PyObject *impl_uvicorn$_subprocess$$$function__2_subprocess_started(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    // Preserve error status for checks
#ifndef __NUITKA_NO_ASSERT__
    NUITKA_MAY_BE_UNUSED bool had_error = ERROR_OCCURRED();
#endif
    ...
    if (isFrameUnusable(cache_frame_447d6820042fae91423afc12c9b83ae5)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_447d6820042fae91423afc12c9b83ae5 = MAKE_FUNCTION_FRAME(codeobj_447d6820042fae91423afc12c9b83ae5, module_uvicorn$_subprocess, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_447d6820042fae91423afc12c9b83ae5);
    ...
    }
    {
        ...
        frame_447d6820042fae91423afc12c9b83ae5->m_frame.f_lineno = 76;
        {
            ...
            tmp_call_result_2 = CALL_FUNCTION_WITH_NO_ARGS_KWSPLIT(tmp_called_value_1, kw_values, mod_consts[15]);
        }
...
PyObject *modulecode_uvicorn$_subprocess(PyObject *module, struct Nuitka_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
...
#ifdef _NUITKA_TRACE
        PRINT_STRING("uvicorn._subprocess: Calling createModuleConstants().\n");
#endif
        createModuleConstants();

        /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
        PRINT_STRING("uvicorn._subprocess: Calling createModuleCodeObjects().\n");
#endif
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *spec_value = CALL_FUNCTION_WITH_SINGLE_ARG(_spec_from_module, module_uvicorn$_subprocess);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_fd206b9d0de31e3f4e57a19b0903ac9b);
